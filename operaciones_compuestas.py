...
def obtener_estado_dedos(landmarks, hand_label):
    """Devuelve una lista de 5 elementos (1 si el dedo está arriba, 0 si está abajo)"""
    fingers = []
    # Pulgar
    if hand_label == "Right":
...
def descifrar_simbolo(dedos_derecha):
    """Mapea la combinación exacta de dedos levantados a su respectivo operador matemático"""
...
while cap.isOpened():
    ...
    # Identificacion de modos con la mano izquierda
    ...
    # --- SISTEMA DE CONTROL DE TIEMPO BAJO DETECCION ---
