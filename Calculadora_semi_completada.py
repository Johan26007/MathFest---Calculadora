    ...
    while cap.isOpened():
        ...
        if estado_actual == 2:
            if not results.multi_hand_landmarks:
                ...
                cv2.putText(img, f"MODO SIMBOLOS | Detectado: {valor_detectado_actual}", (30, 40), font, 0.8, (88, 166, 255), 2)
            else:
                digito_visual = str(valor_detectado_actual) if valor_detectado_actual > 0 else "Puno (Confirmar/Resolver)"
                cv2.putText(img, f"MODO NUMEROS | Digito: {digito_visual}", (30, 40), font, 0.8, (63, 185, 80), 2)
        ...
        cv2.imshow("MathFest - Calculadora", img)
...
def main(page: ft.Page):
    ...
    def aviso_ecuaciones():
        page.snack_bar = ft.SnackBar(
            content=ft.Text("Modulo de ecuaciones listo para agregar despues.", color=TEXT),
            bgcolor="#1a2436",
        )
                            ...
                            ft.Container(
                                ...
                                content=ft.Row(
                                    ...
                                    controls=[
                                        ...
                                        ft.Icon(
                                            icono("POWER_SETTINGS_NEW", "power_settings_new"),
                                            size=16,
                                            color=RED,
                                        ),
                                    ],
